    ...
    <Router>
      <header className="site-header">
        <div className="container">
          <h1>IITB-ASC Course Manager</h1>
          <a href="https://github.com/sssshish" target="_blank" rel="noopener noreferrer" className="github-link">
      ...
      <nav>
        ...
        <Link to="/instances/create"> Create Course Instance</Link> |
        <Link to="/instances"> View Course Instances</Link>
